public class TubeClass {
	public static void main(String[] args) {
		...
		myChannel[0] = new MyChannel("PT", "팜나무", new IntDate(20210730), Classy.CF_CLASSY);
		myChannel[1] = new MyChannel("CF", "ClockFire", new IntDate(20210804), Classy.CF_CLASSY);
		myChannel[2] = new MyChannel("PR", "맥동전파원", new IntDate(20220511), Classy.PN_CLASSY);
		myChannel[3] = new MyChannel("PN", "행성상성운", new IntDate(20220710), Classy.PN_CLASSY);
